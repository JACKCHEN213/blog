        ...
        <form action="{{url('admin/config/'.$data->conf_id.'')}}" method="post" >
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>配置项类型：</th>
                    <td>
                        <input type="radio" name="field_type" value="input" @if($data->field_type == 'input') checked @endif onclick="showTr(this)">input&nbsp;&nbsp;
                        <input type="radio" name="field_type" value="textarea" @if($data->field_type == 'textarea') checked @endif onclick="showTr(this)">textarea&nbsp;&nbsp;
                        <input type="radio" name="field_type" value="radio" @if($data->field_type == 'radio') checked @endif onclick="showTr(this)">radio
                    </td>
                </tr>
                <tr>
                    <th>类型值：</th>
                    <td>
                        <input type="text" id="field_value_id" class="lg" name="field_value" readonly  value="{{$data->field_value}}" onclick="showText()">
                ...
                <tr>
                    <th>排序：</th>
                    <td>
                        <input type="number" class="sm" name="conf_order"  value="{{$data->conf_order}}">
                    </td>
                </tr>
                <tr>
                    <th>配置项说明：</th>
                    <td>
                        <textarea name="conf_tips" value="{{$data->conf_tips}}"></textarea>
                    </td>
                </tr>
                <tr>
                    <th></th>
