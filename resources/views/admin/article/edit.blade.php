        ...
        <form action="{{url('admin/article/'.$art->art_id.'')}}" method="post" >
            ...
            <table class="add_tab">
                ...
                <tr>
                    <th>文章标题：</th>
                    <td>
                        <input type="text" class="lg" value="{{$art->art_title}}" name="art_title">
                    </td>
                </tr>
                <tr>
                    <th>作者：</th>
                    <td>
                        <input type="text" class="sm" value="{{$art->art_editor}}" name="art_editor">
                    </td>
                </tr>
                <tr>
                    <th>缩略图：</th>
                    <td>
                        ...
                        <input id="img_thumb_path" value="{{$art->art_thumb}}" readonly>
                        <button type="button" id="img_thumb_btn" onclick="document.getElementById('img_thumb').click()">上传图片</button>
                    </td>
                </tr>
                <tr>
                    <td>
                        <img src="{{$art->art_thumb}}" alt="预览图" id="img_thumb_img" style="height: 100px;">
                    </td>
                </tr>
                <tr>
                    <th>标签：</th>
                    <td>
                        <input type="text" class="lg" value="{{$art->art_tag}}" name="art_tag">
                    </td>
                </tr>
                <tr>
                    <th>描述：</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" name="art_content" type="text/plain" style="width: 860px; height: 500px;">{!! $art->art_content !!}</script></script>
                        <script>
