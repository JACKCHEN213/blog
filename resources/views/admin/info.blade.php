    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>北京时间</label><span id="locale_time">{!! '<script> setInterval(function(){var myDate = new Date();document.getElementById("locale_time").innerHTML = myDate.getFullYear() + "年" + myDate.getMonth() + "月" + myDate.getDate() + "日" +myDate.getHours() + "时" + myDate.getMinutes() + "分" + myDate.getSeconds() + "秒";}, 50);</script>' !!}</span>
                </li>
                <li>
