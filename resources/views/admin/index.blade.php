...
<div class="top_box">
	<div class="top_left">
		...
		<ul>
			...
			<li><a href="{{url('/')}}" target="_blank">文章首页</a></li>
		</ul>
	</div>
	<div class="top_right">
		<ul>
			<li>管理员：<?php $user = session('user');echo $user['user_name'];?></li>
...
<div class="menu_box">
	<ul>
		...
		<li>
			...
			<ul class="sub_menu">
				<li><a href="https://9iphp.com/fa-icons" target="_blank"><i class="fa fa-fw fa-font"></i>图标调用</a></li>
...
<div class="bottom_box">
	CopyRight © 2019. Powered By <a href="http://www.houdunwang.com">http://www.houdunwang.com</a>.
</div>
<!--底部 结束-->
@endsection
